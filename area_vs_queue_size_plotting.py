...
final_area_utilization_systolic = list(final_area_utilization_systolic.values())
plt.plot(
...
queue_sizes_array = list(final_area_utilization_array.keys())
final_area_utilization_array = list(final_area_utilization_array.values())
plt.plot(
    queue_sizes_array,
    final_area_utilization_array,
    marker="o",
...
queue_sizes_tree = list(final_area_utilization_tree.keys())
final_area_utilization_tree = list(final_area_utilization_tree.values())
plt.plot(
    queue_sizes_tree,
    final_area_utilization_tree,
    marker="x",
...
plt.ylabel("LUT Area Utilization (%)")
