module comparetor_tb;
    ...
    // Instantiate the comparetor module
    comparetor #(
    ...
    initial begin
        ...
        $dumpfile("comparetor_tb.vcd"); // Specify the dump file name
        $dumpvars(0, comparetor_tb);    // Dump all variables in the module
